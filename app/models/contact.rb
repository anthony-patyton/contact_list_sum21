class Contact < ApplicationRecord
  ...
  # has_many - parent model, one to many relationship, multiple of the object to the parent
  # has_one - parent model, one to one relationship, one parent and 1 child 
